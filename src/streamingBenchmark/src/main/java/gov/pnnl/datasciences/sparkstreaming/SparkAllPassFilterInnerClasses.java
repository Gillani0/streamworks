...
public class SparkAllPassFilterInnerClasses extends Receiver<String> implements Serializable{
	...
	public SparkAllPassFilterInnerClasses(String host_, int port_, String inputFile, int timeWindow, String activeMqService, String activeMQ_Queue, int MAX_LINES){
...
//			  	  	        	System.out.println("INSIDE MAP: "+s);
		  	...
		  	allFlowsMap.foreach(
		  		...
		  		//	String out = "\n Printing for spark's sake:\n";
		  			for (Tuple2<String, Integer> t: rdd.take(1)) {
		  		//	out = out + t.toString() + "\n";
		  				//do nothing
		  			}
...
//		  					else{
//		  						System.out.println("Same f problem: u r idiot again again");
//								System.out.println("Something went wrong...as producer is not instantiated");
//			        			
//			        			classObj.config.activeMQProducer = ActiveMQProducer.createInstance(classObj.config.activeMqService, classObj.config.activeMQ_Queue);
//
	...
	transient ActiveMQProducer activeMQProducer ;
	 ...
	 int MAX_LINES_TO_READ = 0;
		public Config(String host_, int port_, String inputFile, int timeWindow, String activeMqService, String activeMQ_Queue, int MAX_LINES){
			...
			this.sparkConf = new SparkConf().setAppName("SparkAllPassFilterInnerClasses");
